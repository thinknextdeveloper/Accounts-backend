  ...
  const result = await pool
    ...
    .query(`
        SELECT
            ...
            Scheme, DOB, Sex, PermanentAddress, PhoneNo, StudentMobile,
            FatherMobile, MotherMobile, LateralEntry, HostelName, RoomType,
            BusRoute, Stopage, Category, Quota, Session
        FROM Admissions
        WHERE IDNo=@IDNo
    `);
