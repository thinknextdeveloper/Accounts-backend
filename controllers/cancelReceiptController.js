...
//   try {
//     const [colleges, ledgerNames] = await Promise.all([getColleges(), getLedgerNames()]);
//     return res.status(200).json({ success: true, colleges, ledgerNames });
//   } catch (err) {
//     console.log(err);
...
//         success: false,
//         message: "Please specify comment to cancel Receipt",
//       });
//     }
//     if (!transactionId || !receiptNo || !collegeName) {
//       return res.status(400).json({
//         success: false,
//         message: "Missing required receipt details",
//       });
//     }

//     await addCancelledReceipt({
//       transactionId,
//       receiptNo,
//       collegeName,
//       ledgerName,
...
//       cancelledBy: req.user?.username || req.user?.id || null,
//     });

//     return res.status(200).json({
//       success: true,
//       message: "Receipt has been added to Cancelled Receipts",
//     });
//   } catch (err) {
//     console.log(err);
//     return res.status(500).json({ success: false, message: err.message });
...
// module.exports = { getOptions, search, addToCancelled, listCancelled };
